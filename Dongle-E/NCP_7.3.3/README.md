...
* ncp-uart-sw_EZNet7.3.3_V1.0.0.gbl
...
Filename: "ncp-uart-sw_EZNet7.3.3_V1.0.0.gbl"

* 7.3.3.0 build 0

Notable changes for this release:
  * Initial release.
  * Based on Zigbee EmberZNet SDK 7.3.3.0 GA from Silicon Labs
  * Built with Silicon Labs Gecko SDK Suite 4.3
